...
The system is built using **FastAPI and RabbitMQ**, and is designed to **separate control-plane logic from task execution**, mirroring patterns used in production orchestration platforms.
